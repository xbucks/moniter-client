...
#[cfg(doc)]
use {crate::zip::read::ZipFile, crate::zip::write::FileOptions};
...
#[cfg(feature = "time")]
use crate::zip::result::DateTimeRangeError;
#[cfg(feature = "time")]
...
pub struct ZipFileData {
    ...
    pub compression_method: crate::zip::compression::CompressionMethod,
...
impl ZipFileData {
    ...
    pub fn version_needed(&self) -> u16 {
        ...
        match (self.zip64_extension(), self.compression_method) {
            #[cfg(feature = "bzip2")]
            (_, crate::zip::compression::CompressionMethod::Bzip2) => 46,
            (true, _) => 45,
            _ => 20,
        }
    }
